...
<head>
  <title>Artistic Designs -- Kitchen</title>
  <!-- PHP File Includes -->
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <ul class="gallery-inner">
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/ki1.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/ki1.jpg" alt="Kitchen 1">
                  </a>
                </li>
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/ki2.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/ki2.jpg" alt="Kitchen 2">
                  </a>
                </li>
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/ki3.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/ki3.jpg" alt="Kitchen 3">
                  </a>
                </li>
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/ki4.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/ki4.jpg" alt="Kitchen 4">
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-sm-5">
              <div class="project-info">
                <ul>
                  ...
                  <!-- Category -->
                  <li>
                    <b>Category:</b> French Country
                  </li>
                </ul>
              </div>
              <!-- Description -->
              <div class="project-description">
                <p>The herringbone travertine floor, custom cabinetry and stone counters, light fixtures by Visual Comfort, French toile custom window treatments and a hand painted mural of a small French village frequently visited by the client  once again create an old-world feel in this lovely kitchen.</p>
              </div>
            </div>
            </div><!-- row -->
            </div><!-- /container -->
