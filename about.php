                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3">
                      <a href="https://www.google.com/" target="_blank">
                        <img src="./assets/img/about/bbbb.jpg" alt="Specifie an alternate text for an image" >
                      </a>
                    </div>
                    <!-- Client Image -->
                    <div class="col-sm-6 col-md-3">
                      <a href="https://www.google.com/" target="_blank">
                        <img src="http://www.kravet.com/img/inspiredkravet.png" alt="Specifie an alternate text for an image" >
                      </a>
                    </div>
                    <!-- Client Image -->
                    <div class="col-sm-6 col-md-3">
                      <a href="https://www.google.com/" target="_blank">
                        <img src="http://www.duralee.com/pub/designresponsive/home-banner-duralee-icon.png" alt="Specifie an alternate text for an image" >
                      </a>
                    </div>
                    <!-- Client Image -->
                    <div class="col-sm-6 col-md-3">
                      <a href="https://www.google.com/" target="_blank">
                        <img src="http://media.lightingnewyork.com/grfx/micro/vcm.png" alt="Specifie an alternate text for an image" >
                      </a>
                    </div>
                    </div><!-- /row -->
                    </div><!-- /container -->
