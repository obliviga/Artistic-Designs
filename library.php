...
<head>
  <title>Artistic Designs -- Library</title>
  <!-- PHP File Includes -->
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <ul class="gallery-inner">
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/li1.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/li1.jpg" alt="Library 1">
                  </a>
                </li>
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/li2.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/li2.jpg" alt="Library 2">
                  </a>
                </li>
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/li3.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/li3.jpg" alt="Library 3">
                  </a>
                </li>
                <!-- Image -->
                <li>
                  <a href="assets/img/portfolio/li4.jpg" data-lightbox="example-set">
                    <img src="assets/img/portfolio/li4.jpg" alt="Library 4">
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="col-sm-5">
              <div class="project-info">
                <ul>
                  ...
                  <!-- Category -->
                  <li>
                    <b>Category:</b> English
                  </li>
                </ul>
              </div>
              <!-- Description -->
              <div class="project-description">
                <p>A traditional two story library with custom iron railings and spiral staircase inspired by the Biltmore Estate.  Housed in the custom made bookcases are original Mark Twain books.  The mantle is of Onyx marble and is coupled with an authentic herringbone brick fireplace insert. Handmade wool area rugs, custom stain glass &amp; dome, faux wall texture and  with period appropriate furniture create an Old World feel in this lovely home.</p>
              </div>
            </div>
            </div><!-- row -->
            </div><!-- /container -->
